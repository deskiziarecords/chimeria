"""
fix_pipeline.py  —  Run this ONCE from the backend folder.
It overwrites smk_pipeline.py with a clean version.

Usage:
    cd C:/Users/Roberto/Documents/chimeria/smk_ipda_trading_system/backend
